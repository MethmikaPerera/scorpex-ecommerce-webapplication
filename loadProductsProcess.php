...
$q = "SELECT * FROM `product` WHERE status_id='1' ORDER BY `id` ASC";
...
?>
    ...
    <div class="flex-c-m flex-w w-full p-t-45">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item" style="cursor:pointer;"><a href="#" class="page-link text-dark" <?php
                                                            if ($pageno <= 1) {
                                                                echo ("#");
                                                            } else {
                                                            ?>onclick="loadProducts(<?php echo ($pageno - 1); ?>);" <?php
                                                                                                                }
                                                                                                                    ?>>Previous</a></li>
                <?php
                ...
                ?>
                        <li class="page-item active" style="cursor:pointer;">
                            <a href="#" class="page-link text-bg-dark" onclick="loadProducts(<?php echo $y; ?>);"><?php echo $y; ?></a>
                        </li>
                    <?php
                    } else {
                    ?>
                        <li class="page-item" style="cursor:pointer;">
                            <a href="#" class="page-link text-dark" onclick="loadProducts(<?php echo $y; ?>);"><?php echo $y; ?></a>
                        </li>
                <?php
                    }
                }
